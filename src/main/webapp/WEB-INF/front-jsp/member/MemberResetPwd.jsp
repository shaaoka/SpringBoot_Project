	...
	<body>
						...
						<div class="card mb-0">
							<div class="card-body">
								...
								<form method="POST" action="changePwdByToken">
									<div class="mb-6">
										<i class="fa fa-user icon"></i><label for="newPwd"
									...
									<br>
									<div class="mb-6">
										<i class="fa fa-key icon"></i><label for="againpwd"
											class="form-label">再次輸入密碼</label>
										<input type="password" class="form-control" id="againpwd" name="againpwd"
											required><span onclick="oneRestClick()"
		...
		<script>
			...
			function checkpwd() {
				...
				var y = document.getElementById("againpwd");
