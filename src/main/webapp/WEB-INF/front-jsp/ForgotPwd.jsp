<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<body>
						...
						<div class="card mb-0">
							<div class="card-body">
								...
								<form method="POST" action="ForgotPwd">
									<div class="mb-3">
										<i class="fa fa-envelope icon"></i><label for="mEmail"
											class="form-label">電子信箱</label>
										<input type="email" class="form-control" id="mEmail"
											aria-describedby="emailHelp" name="mEmail" required><span
											onclick="oneEmailClick()" style="color: rgb(204, 63, 63);">點我輸入</span>
									</div>
		...
		<!-- Article End -->
		<script>
			function oneEmailClick() {
				$('#mEmail').val('cathy.k0124@gmail.com');
			}
		</script>
